...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-sky-50 flex items-center justify-center p-4 py-10">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
                    <div className="mb-6">
                        ...
                        <p className="text-slate-500 text-sm mt-1">Join WC Telehealth today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input type="email" placeholder="you@example.com" className="rounded-xl h-11" {...register('email')} />
                    ...
                    <div className="mt-6 space-y-2 text-center text-sm text-slate-500">
                        ...
                        <p>
                            ...
                            <Link href="/register/doctor" className="text-cyan-600 font-semibold hover:text-cyan-700 transition-colors">
                                Doctor registration
                            </Link>
                        </p>
                    </div>
